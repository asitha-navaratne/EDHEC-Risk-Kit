...
def get_ffme_returns():
    ...
    """
    me_m = pd.read_csv("Downloads/data/Portfolios_Formed_on_ME_monthly_EW.csv",
...
def get_hfi_returns():
    ...
    """
    hfi = pd.read_csv("Downloads/data/edhec-hedgefundindices.csv",
...
def skewness(r):
    ...
    """
    demeaned_r = r - r.mean()
    # use the population standard deviation, so set dof = 0  i.e. degrees of freedom
...
def kurtosis(r):
    ...
    """
    demeaned_r = r - r.mean()
    # use the population standard deviation, so set dof = 0  i.e. degrees of freedom = 0
    sigma_r = r.std(ddof=0)
...
def var_gaussian(r, level=5, modified=False):
    ...
    """
    # compute the Z score assuming it as Gaussian
...
def glidepath_allocator(r1, r2, start_glide=100, end_glide=0):
    """
